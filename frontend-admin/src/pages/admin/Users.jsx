...
const Users = () => {
    ...
    const [marcas, setMarcas] = useState([
        { id: 1, nombre: 'Christian Alessandro', apellido: 'Marín Sandoval'},
        { id: 2, nombre: 'Angel Mauricio', apellido: 'Chevez Campos'},
        { id: 3, nombre: 'Ethan David', apellido: 'Henriquez Diaz'},
        { id: 4, nombre: 'Josue Alejandro', apellido: 'Hernandez García'},
        { id: 5, nombre: 'Jesus Stanley', apellido: 'Arce Dueñas'},
        { id: 6, nombre: 'Adriel Levi', apellido: 'Moreno Solano'},
        { id: 7, nombre: 'Thomas Alexander', apellido: 'Galdamez Palomares'},
        { id: 8, nombre: 'Jonatan Pedro', apellido: 'Figueroa Espinoza'},
        { id: 9, nombre: 'Valentina Sofía', apellido: 'Herrera Rivas'},
        { id: 10, nombre: 'Santiago Tomás', apellido: 'Rivas Soto'},
        { id: 11, nombre: 'Camila Antonella', apellido: 'Soto Morales'},
        { id: 12, nombre: 'Lucas Emmanuel', apellido: 'Morales Díaz'},
        { id: 13, nombre: 'Isabella Fernanda', apellido: 'Díaz González'},
        { id: 14, nombre: 'Matías Alejandro', apellido: 'González Paredes'},
        { id: 15, nombre: 'Emilia Antonia', apellido: 'Paredes Vargas'},
        { id: 16, nombre: 'Benjamín Nicolás', apellido: 'Vargas Bravo'},
        { id: 17, nombre: 'Catalina Isidora', apellido: 'Bravo Fuentes'},
        { id: 18, nombre: 'Tomás Ignacio', apellido: 'Fuentes Salinas'},
        { id: 19, nombre: 'Antonia Paz', apellido: 'Salinas Navarro'},
        { id: 20, nombre: 'Diego Andrés', apellido: 'Navarro Castillo'}
    ]);
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="flex justify-between items-center mb-6">
                        <div className="flex items-center space-x-3">
                            ...
                            <User size={26} className="text-[#41D7FC]" />
                        </div>
                    ...
                    <div className="bg-[#10083A] rounded-xl shadow-lg overflow-hidden">
                        <div className="max-h-[calc(100vh-300px)] overflow-y-auto custom-scrollbar">
                            {marcasFiltradas().map((marca) => (
                                ...
                                >
                                    <div className="flex items-center space-x-4">
                                        <div className="bg-[#1C1650] rounded-full p-2">
                                            <User size={24} className="text-[#41D7FC]" />
                                        </div>
                                        <div>
                                            <div className="text-white font-mono text-sm">{marca.nombre}</div>
                                            <div className="text-[#41D7FC] font-mono text-xs">{marca.apellido}</div>
                                        </div>
                                    </div>
                                    <button
