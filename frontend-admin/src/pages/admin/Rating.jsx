...
export default function ReviewApproval() {
  ...
  return (
<div className="min-h-screen bg-[#0b032d] text-white">
      {/* NAVBAR */}
<nav className="bg-[#1C1650] p-4 shadow-md w-full">
...
<div className="bg-[#1c1240] w-full max-w-2xl rounded-2xl p-4 border border-[#3f2d7a] shadow">
